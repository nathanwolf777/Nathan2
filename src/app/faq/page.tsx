...
const faqs = [
  ...
  },
  {
    ...
    a: "Le cadre Solo met en avant une performance individuelle (39,99 €). Le cadre Duo affiche deux participants avec deux emplacements de patch et le temps de l'équipe (44,99 €). Le cadre Duo (1 patch) affiche également deux participants mais avec un seul emplacement de patch (39,99 €). Le cadre Hexagone, plus compact, met en valeur une performance individuelle dans un format hexagonal (21,99 €).",
  },
  {

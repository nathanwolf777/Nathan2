...
export const metadata: Metadata = {
  ...
  description:
    "Cadres souvenirs personnalisés pour les passionnés de compétitions fitness. Immortalisez vos performances avec un cadre premium en édition unique. À partir de 21,99 € — livraison offerte en point relais, en France.",
  keywords: [
    "cadre personnalisé",
    "fitness",
    "compétition",
  ...
  openGraph: {
    ...
    description:
      "Cadres souvenirs personnalisés premium pour athlètes. À partir de 21,99 € — livraison offerte en point relais, en France.",
    url: baseUrl,

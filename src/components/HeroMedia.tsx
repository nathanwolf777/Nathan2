  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative grid grid-cols-5 gap-2 sm:gap-3 items-stretch"
      >
        {/* LEFT — video (or placeholder) */}
        <div className="col-span-3 relative rounded-2xl overflow-hidden shadow-2xl border border-white/[0.06] min-h-[380px]">
          {hasVideo ? (
            <video
              ref={videoRef}
              src="/hero.mp4"
        ...
        <div className="col-span-2 grid grid-rows-2 gap-2 sm:gap-3">
          <PhotoTile
            src="/cadre-hero.jpg"
...
function PhotoTile({
  ...
  return (
    <motion.div
      ...
      className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/[0.06]"
    >
      <Image
        src={src}
        alt={alt}
